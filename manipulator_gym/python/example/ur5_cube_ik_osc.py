...
# load franka asset
franka_asset_file = "urdf/ur5e/urdf/ur5.urdf"
asset_options = gymapi.AssetOptions()
...
franka_hand_index = franka_link_dict["ee_link"]
...
for i in range(num_envs):
    ...
    # add franka
    franka_handle = gym.create_actor(env, franka_asset, franka_pose, "ur5e", i, 2)
    ...
    hand_handle = gym.find_actor_rigid_body_handle(env, franka_handle, "ee_link")
    hand_pose = gym.get_rigid_transform(env, hand_handle)
    init_pos_list.append([hand_pose.p.x, hand_pose.p.y, hand_pose.p.z])
    init_rot_list.append([hand_pose.r.x, hand_pose.r.y, hand_pose.r.z, hand_pose.r.w])

    # get global index of hand in rigid body state tensor
    hand_idx = gym.find_actor_rigid_body_index(env, franka_handle, "ee_link", gymapi.DOMAIN_SIM)
